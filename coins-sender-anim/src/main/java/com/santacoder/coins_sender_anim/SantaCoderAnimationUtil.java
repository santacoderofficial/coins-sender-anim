package com.santacoder.coins_sender_anim;

/**
 * Created by Santa Coder on May 11, 2023.
 * https://santacoder.com
 */
...
public class SantaCoderAnimationUtil {
    private static final int DEFAULT_DURATION = 1000;
    private static final int DEFAULT_DURATION_DISAPPEAR = 200;
    private View mTarget; // Sender
    private View mDest; // Receiver
    ...
    private int mDisappearDuration = DEFAULT_DURATION_DISAPPEAR; // Control for bet

    private WeakReference<Activity> mContextReference;
    private int mBorderWidth = 4;
    private int mBorderColor = Color.BLACK;
    private boolean isHideTargetView = false;
    //    private CircleLayout mCircleLayout;
    private Bitmap mBitmap;
    private SantaCoderCircleImageView mImageView;
    private Animator.AnimatorListener mAnimationListener;

    public SantaCoderAnimationUtil() {
    }

    public SantaCoderAnimationUtil attachActivity(Activity activity) {
        mContextReference = new WeakReference<Activity>(activity);
        return this;
    }

    public SantaCoderAnimationUtil setTargetView(View view) {
        mTarget = view;
        setOriginRect(mTarget.getWidth(), mTarget.getHeight());
        return this;
    }

    private SantaCoderAnimationUtil setOriginRect(float x, float y) {
        originX = x;
        originY = y;
        return this;
    }

    private SantaCoderAnimationUtil setDestRect(float x, float y) {
        destX = x;
        destY = y;
        return this;
    }

    public SantaCoderAnimationUtil setDestView(View view) {
        mDest = view;
        setDestRect(mDest.getWidth(), mDest.getWidth());
        return this;
    }

    public SantaCoderAnimationUtil setBorderWidth(int width) {
        mBorderWidth = width;
        return this;
    }

    public SantaCoderAnimationUtil setBorderColor(int color) {
        mBorderColor = color;
        return this;
    }

    public SantaCoderAnimationUtil isHideTargetView(boolean hideForTrue) {
        isHideTargetView = hideForTrue;
        return this;
    }

    public SantaCoderAnimationUtil setCircleDuration(int duration) {
        mCircleDuration = duration;
        return this;
    }

    public SantaCoderAnimationUtil setMoveDuration(int duration) {
    ...
    private boolean prepare() {
        if (mContextReference.get() != null) {
            ...
            if (mImageView == null)
                mImageView = new SantaCoderCircleImageView(mContextReference.get());
...
//        mTarget.setVisibility(View.VISIBLE);
    ...
    public SantaCoderAnimationUtil setAnimationListener(Animator.AnimatorListener listener) {
